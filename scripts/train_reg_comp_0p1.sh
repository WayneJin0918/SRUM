...
torchrun \
  ...
  --dataset_config_file scripts/data/rft_comp_0p1_reg_bi.yaml \
  ...
  --save_every 1216 \
  --total_steps 1217 \
  --checkpoint_dir "results/rft_comp_0p1_reg_bi_lam_0p5_2e5" \
...
torchrun \
  ...
  --master_port=$master_port \
  train/pretrain_unified_navit.py \
  --dataset_config_file scripts/data/rft_comp_0p1_sample_bi.yaml \
  --model_path $model_path \
  --visual_gen True \
  --visual_und False \
  --freeze_llm False \
  ...
  --save_every 480 \
  --total_steps 481 \
  --checkpoint_dir "results/rft_comp_0p1_sample_bi_lam_0p5_2e5" \
  --lambda_constraint 0.5 \
...
torchrun \
  ...
  --master_port=$master_port \
  train/pretrain_unified_navit.py \
  --dataset_config_file scripts/data/rft_comp_0p1_sample.yaml \
  --model_path $model_path \
  --visual_gen True \
  --visual_und False \
  --freeze_llm False \
  ...
  --save_every 480 \
  --total_steps 481 \
  --checkpoint_dir "results/rft_comp_0p1_sample_lam_0p5_2e5" \
  --lambda_constraint 0.5 \