...
#   --save_every 395 \
#   --total_steps 396 \
#   --checkpoint_dir "results/rft_cul_wise_con_0p5_2e5" \
...
#   --master_port=$master_port \
#   train/pretrain_unified_navit.py \
#   --dataset_config_file scripts/data/rft_ns_wise.yaml \
#   --model_path $model_path \
#   --visual_gen True \
#   --visual_und False \
#   --freeze_llm False \
...
#   --save_every 296 \
#   --total_steps 297 \
#   --checkpoint_dir "results/rft_ns_wise_con_0p5_2e5" \
#   --lambda_constraint 0.5 \
  ...
  --master_port=$master_port \
  train/pretrain_unified_navit.py \
  --dataset_config_file scripts/data/rft_st_wise.yaml \
  --model_path $model_path \
  --visual_gen True \
  --visual_und False \
  --freeze_llm False \
  ...
  --save_every 292 \
  --total_steps 293 \
  --checkpoint_dir "results/rft_st_wise_con_0p5_2e5" \
  --lambda_constraint 0.5 \